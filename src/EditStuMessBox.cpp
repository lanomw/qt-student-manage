...
/**
 * 构建添加学生主界面
 * QVBoxLayout 局部工具防止 QFarmLayout 和 QHBoxLayout
...
EditStuMessBox::EditStuMessBox() {
    ...
    // 按钮事件
    connect(submit, &QPushButton::clicked, this, &EditStuMessBox::saveStuMess);
    connect(cancel, &QPushButton::clicked, this, &EditStuMessBox::close);
}
